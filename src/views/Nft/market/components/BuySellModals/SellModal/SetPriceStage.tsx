...
import { Flex, Grid, Box, Text, Button, CronosIcon, ErrorIcon, useTooltip, Skeleton } from '@pancakeswap/uikit'
    ...
    <>
      ...
      <GreyedOutContainer>
        ...
        <Flex>
          <Flex flex="1" alignItems="center">
            <CronosIcon width={24} height={24} mr="4px" />
            <Text bold>WCRO</Text>
          </Flex>
          <Flex flex="2">
            <RightAlignedInput
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          ...
          <Text small color="textSubtle">
            {t('Sales are in WCRO. You can swap WCRO to CRO 1:1 for free with OrbitalSwap.')}
          </Text>
        </Box>
      </Grid>
      <Divider />
