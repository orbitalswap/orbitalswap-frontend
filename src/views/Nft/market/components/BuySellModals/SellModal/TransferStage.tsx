import { Flex, Grid, Text, Button, Input, CronosIcon, ErrorIcon } from '@pancakeswap/uikit'
...
const TransferStage: React.FC<TransferStageProps> = ({
  ...
  const getErrorText = () => {
    if (isInvalidTransferAddress) {
      return t('That’s not a Cronos Chain wallet address.')
    }
          ...
          {lowestPrice && (
            <>
              ...
              <Flex alignItems="center" justifyContent="flex-end">
                <CronosIcon width={16} height={16} mr="4px" />
