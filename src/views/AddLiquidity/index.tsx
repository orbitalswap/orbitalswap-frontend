...
import { Currency, currencyEquals, TokenAmount, WNATIVE } from '@orbitalswap/sdk'
...
export default function AddLiquidity() {
  ...
  const [approvalA, approveACallback] = useApproveCallback(parsedAmounts[Field.CURRENCY_A], ROUTER_ADDRESS[DEFAULT_CHAIN_ID])
  const [approvalB, approveBCallback] = useApproveCallback(parsedAmounts[Field.CURRENCY_B], ROUTER_ADDRESS[DEFAULT_CHAIN_ID])
